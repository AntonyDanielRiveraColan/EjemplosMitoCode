...
public class FechasConDateApi {
  ...
  /**
   * El sgt metodo verifica el tiempo. Se realiza una comparativa con las formas de java 7 y 8
   * respectivamente
   */
  ...
  /**
   * El sgt metodo medir el tiempo. Se realiza una comparativa con las formas de java 7 y 8
   * respectivamente
   */
  ...
  /**
   * El sgt metodo verifica el periodo entre fechas. Se realiza una comparativa con las formas de
   * java 7 y 8 respectivamente
   */
  ...
  public void periodoEntreFehcas(int version) {
    if (version == 7) {
      ...
      System.out.println(
          "Han transcurrido " + period.getYears() + " años y " + period.getMonths() + " meses y "
              + period.getDays()
  ...
  /**
   * El sgt metodo verifica la conversion de fechas. Se realiza una comparativa con las formas de
   * java 7 y 8 respectivamente
   */
  ...
  /**
   * El sgt metodo es el principal de la clase.
   */
