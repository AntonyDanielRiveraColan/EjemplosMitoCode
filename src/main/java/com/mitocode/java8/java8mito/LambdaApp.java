...
public class LambdaApp {
  ...
  /**El sgt metodo ordena e imprime usando expresiones lambda.*/
  public void ordenar() {
  ...
  /**
   * public void calcular() { Operacion operacion = (double x, double y) -> (x+y)/2;
  ...
  /**El sgt metodo es el principal el cual hace el llamado a los creados anteriormente.*/
